...
<p style="text-align: center; margin-top: 15px; font-size: 12px; color: #9CA3AF;"><a href="${SITE_URL}/api/unsubscribe?id=${bookingUuid}" style="color: #6B7280; text-decoration: underline;">Unsubscribe from emails</a></p>
</body></html>`;
    ...
    await sendBookingEmailAndTrack({
      ...
      html, icalString,
      unsubscribeUrl: `${SITE_URL}/api/unsubscribe?id=${bookingUuid}`,
    });
  } catch (err) {
