...
const ColorPalette = () => {
  const colorOptions = [
    ...
    },
    {
      ...
      primary: "#20B2AA",
      light: "#E0F7F5",
      description: "Professional yet approachable, excellent for trust-building"
    },
    {
      name: "Bold Orange",
      primary: "#FF8C42", 
      light: "#FFF0E6",
      description: "High energy and attention-grabbing, perfect for action elements"
    },
    {
      ...
      <div className="max-w-6xl mx-auto">
          ...
          <div className="space-y-8">
            {colorOptions.map((option, index) => (
              <div key={index} className="bg-white rounded-lg p-6 shadow-sm border">
                ...
                <div className="mt-4 p-4 rounded-lg" style={{ backgroundColor: baseColors.lightGray }}>
                  <div className="flex items-center gap-4">
                    ...
                    <div 
                      ...
                      style={{ backgroundColor: option.primary }}
                    ></div>
                    <span className="text-sm text-gray-600">Combined palette preview</span>
                  </div>
                </div>
              </div>
            ))}
        ...
        <div className="mt-12 p-6 bg-blue-50 rounded-lg">
          ...
          <p className="text-blue-800 text-sm">
            For a self-defense business, I'd recommend either <strong>Confident Teal</strong> or <strong>Energetic Coral</strong>. 
            Teal conveys trust and professionalism (great for corporate clients), while coral is empowering and 
            action-oriented (perfect for motivating personal safety action).
          </p>
        </div>
      </div>
    </div>
