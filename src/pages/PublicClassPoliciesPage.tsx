...
const PublicClassPolicies = () => {
  return (
    <div>
      <Helmet>
        <title>Public Class Policies | Streetwise Self Defense</title>
        <meta name="description" content="Booking, cancellation, and rescheduling policies for our public self-defense training classes." />
      </Helmet>
            ...
            <div className="p-6 bg-white">
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  <span className="text-accent-primary font-bold text-xl mt-1">•</span>
            ...
            <div className="p-6 bg-white">
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  <span className="text-accent-primary font-bold text-xl mt-1">•</span>
                  <span className="text-gray-700 flex-1">
                    <strong className="text-navy">Requests must be made at least 72 hours before class start time.</strong>
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-accent-primary font-bold text-xl mt-1">•</span>
                  <span className="text-gray-700 flex-1">
                    We'll do our best to place you in a future class of the same type, subject to availability.
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-accent-primary font-bold text-xl mt-1">•</span>
                  <span className="text-gray-700 flex-1">
                    <strong className="text-navy">First reschedule is free.</strong> If you need to reschedule more than once, a $20 administrative fee applies to each additional reschedule.
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-accent-primary font-bold text-xl mt-1">•</span>
                  <span className="text-gray-700 flex-1">
                    Reschedule requests within 72 hours will be accommodated when possible, but availability is not guaranteed.
                  </span>
                </li>
              </ul>
              ...
              <div className="mt-6 bg-gradient-to-r from-accent-primary/10 to-navy/10 border-l-4 border-accent-primary p-4 rounded">
                <p className="text-gray-700">
                  <strong className="text-navy">Life happens!</strong> We understand emergencies occur. Contact us as soon as possible and we'll work with you to find a solution.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="p-6 bg-white">
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  <span className="text-accent-primary font-bold text-xl mt-1">•</span>
                  <span className="text-gray-700 flex-1">
                    <strong className="text-navy">Full refund available if cancellation is made at least 2 weeks (14 days) before class.</strong>
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-accent-primary font-bold text-xl mt-1">•</span>
                  <span className="text-gray-700 flex-1">
                    <strong className="text-navy">Less than 2 weeks notice:</strong> No refund available, but every effort will be made to help you reschedule into another class.
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-accent-primary font-bold text-xl mt-1">•</span>
                  <span className="text-gray-700 flex-1">
                    <strong className="text-navy">Substitutions always allowed:</strong> You may send a friend or family member in your place (must meet age and eligibility requirements).
                  </span>
                </li>
              </ul>
            </div>
