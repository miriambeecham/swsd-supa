...
const PrivateClassStaticPage = () => {
  return (
    <div className="min-h-screen bg-white">
      <Helmet>
        <title>Class Preparation - Private Self Defense Training</title>
              ...
              <div className="grid md:grid-cols-2 gap-8 items-center">
                <div>
                  <p className="text-gray-700 text-lg mb-4">
                    This will be the location we discussed when scheduling your class. More often than not, it will be at or near your home.
                  </p>
                  <p className="text-gray-700 mb-4">
                    If I have any questions about location, I will have your number for text messaging prior to our class date/time.
                  </p>
