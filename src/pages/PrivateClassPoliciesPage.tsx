...
const PrivateClassPolicies = () => {
  return (
    <div>
      <Helmet>
        <title>Private Class Policies | Streetwise Self Defense</title>
        <meta name="description" content="Booking, cancellation, and rescheduling policies for our private self-defense training sessions." />
      </Helmet>
            ...
            <div className="p-6 bg-white">
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  <span className="text-navy font-bold text-xl mt-1">•</span>
